    ...
    return (
        <div className="privacy-container">
            ...
            <section className="privacy-section">
                ...
                <p className="privacy-text"> Rental System respects your privacy and is committed to protecting the personal information you share with us. This Privacy Policy outlines how we collect, use, disclose, and protect your information when you use our accessories rental services.</p>
            </section>
            ...
            <section className="privacy-section">
                ...
                <ul className="privacy-list">
                    ...
                    <li className="privacy-list-item">Accessories preference and rental history</li>
                </ul>
            </section>
